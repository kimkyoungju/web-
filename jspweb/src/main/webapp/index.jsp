...
<body>
	...
	<div id="maincarousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="1000" >
	  ...
	  <div class="carousel-inner">	<!-- 이미지 삽입되는 구역 -->
	    <div class="carousel-item active">	<!-- 이미지	 active : 현재 보이는 이미지 -->
	      <img src="/jspweb/img/im12.jpg" class="d-block w-100" alt="...">
	    </div>
	    <div class="carousel-item ">
	      <img src="/jspweb/img/im1.jpg" class="d-block w-100" alt="...">
	    </div>
	      <div class="carousel-item ">
	      <img src="/jspweb/img/im3.gif" class="d-block w-100" alt="...">
	    </div>
	...
	<div class="container"> <!-- 전체 박스권 -->
		<h6 class="main_title">BEST CHOICE</h6>
		<div class="itemlist">	<!-- 제품출력 구역 -->
