...
function 게임판그리기(){ 
	...
	// 2.승리 = '' // 승리 변수를 공백으로 초기화
	// 3. 게임상황 = [null,null,null,null,null,null,null,null,null] // 배열에 9개 null로 초기화 
	let 게임판 = '' // 빈 변수 선언 
...
/*function 버튼선택( i ){
	...
	1.if( 중복검사(i) ){  // 3. 함수호출해서 해당 위치에 알이 있으면 함수 종료(return)
		2.alert('안내) 이미 둔 자리 입니다.') 
		3.return // 현 위치에서 함수 종료  [ 아래 코드가 실행X]
	}// if end 
